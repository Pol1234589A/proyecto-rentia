...
import { User, Briefcase, ChevronLeft, CheckCircle, Loader2, Save, Lock, Megaphone, ShieldCheck, ArrowRight } from 'lucide-react';
                        ...
                        <div className="mt-8 pt-6 border-t border-gray-100">
                             <label className="flex items-start gap-3 cursor-pointer p-4 hover:bg-gray-50 rounded-xl transition-colors">
                                  ...
                                  <div className="text-xs text-gray-500 leading-relaxed">
                                      ...
                                      Doy mi consentimiento para que Rentia Investments S.L. guarde estos datos con el fin de gestionar mi solicitud. Los datos públicos del encargo (sin mis datos de contacto) podrán ser visibles en el listado de demandas de la web.
                                  </div>
                              </label>
