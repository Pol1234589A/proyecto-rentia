...
export const OwnerDashboard: React.FC = () => {
  ...
  if (viewingInvoice && viewingInvoice.details) {
      const { details } = viewingInvoice;
      const agencyData = details.agencyData;
               ...
               <div className="max-w-[210mm] mx-auto bg-white min-h-[297mm] shadow-2xl my-8 print:shadow-none print:m-0 print:w-full print:max-w-none relative border border-gray-200 print:border-none">
                        ...
                        <div className="w-1/3 text-right">
                            ...
                            <div className="space-y-2 text-sm">
                                ...
                                <div className="flex justify-between bg-gray-50 p-2 rounded">
                                    ...
                                    <span className="font-mono font-bold">{details.month}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="px-12 py-6 bg-gray-50/30 flex justify-between">
                            ...
                            <div className="space-y-1 text-sm text-gray-800">
                                ...
                                {clientData.iban && (
                                    <div className="flex gap-2 items-center bg-yellow-50 p-1 rounded mt-1 border border-yellow-100 w-fit">
                                        ...
                                        <span className="font-mono">{clientData.iban}</span>
                                    </div>
                                )}
                            </div>
                        </div>
                        <div className="w-1/3">
                            ...
                            <p className="text-sm text-gray-700 bg-white border border-gray-100 p-2 rounded h-20">{clientData.propertyAddress}</p>
                        </div>
                    </div>
                            ...
                            {properties.map(p => (
                                <div key={p.id} className="bg-white p-3 rounded-lg border border-gray-200">
                                    <div className="flex justify-between items-center mb-2">
                                        ...
                                        <button 
                                            onClick={() => handleSaveInvestment(p.id)}
                                            className="text-xs bg-rentia-black text-white px-3 py-1 rounded font-bold hover:bg-gray-80