            ...
            <div className="font-sans bg-gray-50 min-h-screen flex flex-col animate-in fade-in duration-500">
                ...
                <section className="relative py-12 md:py-20 bg-rentia-black text-white overflow-hidden">
                    ...
                    <div className="relative z-10 container mx-auto px-4 text-center">
                        <div className={`inline-flex items-center gap-2 backdrop-blur-md border px-4 py-1.5 rounded-full mb-6 font-bold text-xs md:text-sm shadow-xl uppercase tracking-widest ring-1 ${config.modules.maintenanceRooms ? 'bg-red-500/20 border-red-500/50 text-red-100 ring-red-500/20 animate-pulse' : 'bg-white/10 border-white/20 text-white ring-white/10'}`}>
                            {config.modules.maintenanceRooms ? <Hammer className="w-3.5 h-3.5 text-rentia-gold" /> : <Home className="w-3.5 h-3.5 text-rentia-gold" />}
                            <span>{config.modules.maintenanceRooms ? "Sección en Mantenimiento" : t('rooms.hero.badge')}</span>
                        </div>
                        <h1 className="text-3xl md:text-6xl font-bold font-display mb-6 tracking-tight drop-shadow-2xl text-white leading-tight">
                            {config.modules.maintenanceRooms ? (
                                <>Catálogo en <span className="text-rentia-gold text-white/90">Mantenimiento</span></>
                            ) : (
                        ...
                        <p className="text-lg md:text-xl text-gray-300 font-light max-w-2xl mx-auto mb-8 leading-relaxed">
                            {config.modules.maintenanceRooms ? (
                                "Estamos actualizando nuestro catálogo para ofrecerte las mejores opciones de alojamiento. Volveremos a estar disponibles muy pronto."
                            ) : (
                        ...
                        {/* Special Maintenance Header Notice requested by user */}
                        {config.modules.maintenanceRooms && (
                            <div className="mt-12 max-w-2xl mx-auto backdrop-blur-xl bg-white/5 border border-white/10 p-6 rounded-3xl shadow-2xl animate-in zoom-in-95 duration-700">
                                <div className="flex items-center justify-center gap-4 mb-3">
                                    <div className="w-10 h-10 bg-rentia-gold/20 rounded-full flex items-center justify-center border border-rentia-gold/30">
                                        <Hammer className="w-5 h-5 text-rentia-gold" />
                                    </div>
                                    <span className="text-rentia-gold font-black uppercase tracking-[0.3em] text-[10px]">Aviso Especial</span>
                                </div>
                                <div className="text-white">
                                    <p className="font-bold text-sm md:text-base leading-relaxed mb-2">
                                        Estamos optimizando nuestro buscador interno.
                                    </p>
                                    <p className="text-gray-300 text-xs md:text-sm mb-4">
                                        Puedes consultar todas nuestras habitaciones disponibles en nuestro portal oficial de Idealista:
                                    </p>
                                    <a
                                        href="https://www.idealista.com/pro/rentiaroom/"
                                        target="_blank"
                                        rel="noopener noreferrer"
                                        className="inline-flex items-center gap-2 bg-[#edcd20] text-rentia-black font-black px-6 py-2.5 rounded-xl hover:bg-white transition-all shadow-xl text-xs uppercase tracking-wider"
                                    >
                                        Ver habitaciones en Idealista
                ...
                {/* Main Content with Optional Maintenance Blur */}
                <div className={`flex flex-col flex-1 relative ${config.modules.maintenanceRooms ? 'overflow-hidden' : ''}`}>
                    {config.modules.maintenanceRooms && (
                        <div className="absolute inset-0 z-40 backdrop-blur-md bg-white/30 flex flex-col items-center justify-start pt-32 text-center p-4">
                            <div className="bg-white/95 p-10 rounded-3xl shadow-2xl border border-gray-100 max-w-lg animate-in slide-in-from-top-12 duration-700">
                                <div className="w-16 h-16 bg-rentia-black text-rentia-gold rounded-full flex items-center justify-center mx-auto mb-6 shadow-xl">
                                    <Hammer className="w-8 h-8 animate-bounce" />
                                </div>
                                <h2 className="text-3xl font-bold text-gray-900 mb-3 font-display tracking-tight">Acceso Restringido</h2>
                                <p className="text-gray-600 mb-6 text-lg leading-relaxed">
                                    Estamos actualizando nuestro catálogo interno para ofrecerte la mejor información.
                                </p>
                                <div className="bg-gray-50 border border-gray-100 p-6 rounded-2xl mb-8">
                                    <p className="text-gray-500 text-sm mb-4">
                                        Mientras tanto, puedes consultar todas nuestras habitaciones disponibles actualizadas en tiempo real aquí:
                                    </p>
                                    <a
                                        href="https://www.idealista.com/pro/rentiaroom/"
                                        target="_blank"
                                        rel="noopener noreferrer"
                                        className="inline-flex items-center gap-3 bg-[#0072CE] text-white font-bold px-8 py-4 rounded-xl hover:bg-rentia-black transition-all shadow-lg group"
                                    >
                                        <ExternalLink className="w-5 h-5" />
                                        Ver disponibles en Idealista
                                        <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
                                    </a>
                                </div>
                                <div className="inline-flex items-center gap-3 px-6 py-2.5 bg-gray-100 rounded-full text-sm font-black text-rentia-blue uppercase tracking-[0.2em] animate-pulse">
                    ...
                    {/* PLAN AMIGO BANNER moved inside the maintenance-aware div */}
                                ...
                                <div className="space-y-6 max-h-[calc(100vh-220px)] overflow-y-auto pr-2 custom-scrollbar pb-10">
                                    ...
                                    <div>
                                        ...
                                        <select
                                            ...
                                            title="Filtrar por tipo de gastos"
                                        >
                                            <option value="all">Indiferente</option>
                                ...
                                <div className="md:hidden sticky top-0 z-40 -mx-4 px-4 py-2 bg-gray-50/95 backdrop-blur-sm mb-6 transition-all">
                                    <div className="bg-white p-4 rounded-xl shadow-lg shadow-gray-200/50 border border-gray-100 flex flex-col items-start gap-4 ring-1 ring-black/5">
                                        ...
                                        <div className={`${mobileFiltersOpen ? 'flex' : 'hidden'} flex flex-col gap-3 w-full pt-1`}>
                                            ...
                                            <select value={selectedZone} onChange={(e) => setSelectedZone(e.target.value)} className="w-full p-2 bg-gray-50 border rounded-lg text-sm" title="Zona">
                                            ...
                                            <div className="grid grid-cols-2 gap-2">
                                                <select value={selectedGender} onChange={(e) => setSelectedGender(e.target.value)} className="p-2 bg-gray-50 border rounded-lg text-sm" title="Sexo">
                                                    <option value="all">Sexo: Todos</option>
                                                    <option value="male">Solo Chicos</option>
                                                    <option value="female">Solo Chicas</option>
                                                </select>
                                                <select value={selectedProfile} onChange={(e) => setSelectedProfile(e.target.value)} className="p-2 bg-gray-50 border rounded-lg text-sm" title="Perfil">
