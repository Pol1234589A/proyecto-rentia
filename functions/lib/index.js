...
exports.admin_deleteUser = exports.rentger_uploadSignature = exports.rentger_syncAsset = exports.rentger_syncOwner = exports.rentger_ping = void 0;
...
const RENTGER_API_KEY = (_a = functions.config().rentger) === null || _a === void 0 ? void 0 : _a.apikey;
 ...
 */
exports.rentger_ping = functions.region('europe-west1').https.onCall(async (data, context) => {
    if (!RENTGER_API_KEY) {
 ...
 */
exports.rentger_syncOwner = functions.region('europe-west1').https.onCall(async (data, context) => {
 ...
 */
exports.rentger_syncAsset = functions.region('europe-west1').https.onCall(async (data, context) => {
    const { property } = data;
 ...
 */
exports.rentger_uploadSignature = functions.region('europe-west1').https.onCall(async (data, context) => {
 ...
 */
exports.admin_deleteUser = functions.region('europe-west1').https.onCall(async (data, context) => {
