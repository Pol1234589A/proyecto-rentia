    ...
    return (
        <section className="bg-white border-t border-gray-200 py-16 no-print">
            <div className="container mx-auto px-4 max-w-4xl text-center">
                ...
                <a
                    href={`https://api.whatsapp.com/send?phone=${config.directorContact.phone}&text=Hola%20Pol,%20soy%20propietario/inmobiliaria%20y%20me%20gustar%C3%ADa%20colaborar%20con%20vosotros.`}
