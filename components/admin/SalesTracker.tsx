                                        ...
                                        <tr key={act.id} className="hover:bg-blue-50/20 transition-colors group">
                                            ...
                                            <td className="p-4 text-center">
                                                <select 
                                                    ...
                                                    className={`text-[10px] font-bold uppercase px-2 py-1 rounded-full border outline-none cursor-pointer ${
                                                        act.status === 'accepted' ? 'bg-green-100 text-green-700 border-green-200' :
