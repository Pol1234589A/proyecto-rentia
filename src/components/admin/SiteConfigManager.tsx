                ...
                {activeTab === 'team' && (
                    <div className="space-y-8 animate-in fade-in">
                        ...
                        <div className="bg-gray-50 p-4 rounded-xl border border-gray-200">
                            <h4 className="font-bold text-blue-800 mb-4 flex items-center gap-2"><Users className="w-4 h-4" /> Perfil Administración</h4>
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        {/* DIRECTOR CARD */}
                        <div className="bg-gray-50 p-4 rounded-xl border border-gray-200">
                            <h4 className="font-bold text-blue-800 mb-4 flex items-center gap-2"><Users className="w-4 h-4" /> Perfil Dirección</h4>
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
