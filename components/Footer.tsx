...
interface FooterProps {
  onNavigate: (view: 'home' | 'list' | 'contact' | 'services' | 'rooms' | 'about' | 'discounts' | 'brokers' | 'submission') => void;
          ...
          <div>
            ...
            <div className="space-y-4 text-[14px] text-white">
              ...
              <p className="pt-4 mt-2 border-t border-white/20">
                <a href="mailto:info@rentiaroom.com" className="hover:text-[#edcd20] transition-colors block py-1">
            ...
            <div className="flex space-x-3 mt-6">
              <a href="https://www.facebook.com/share/1Cpvx6fmh2/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 flex items-center justify-center rounded-md border-2 border-white text-white hover:bg-white hover:text-[#0072CE] transition-colors" aria-label="Facebook">
              ...
              <a href="https://www.instagram.com/rentiaroom_/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 flex items-center justify-center rounded-md border-2 border-white text-white hover:bg-white hover:text-[#0072CE] transition-colors" aria-label="Instagram">
              ...
              <a href="https://www.linkedin.com/company/rentia-room/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 flex items-center justify-center rounded-md border-2 border-white text-white hover:bg-white hover:text-[#0072CE] transition-colors" aria-label="LinkedIn">
               ...
               <a href="https://www.tiktok.com/@rentiaroom" target="_blank" rel="noopener noreferrer" className="w-10 h-10 flex items-center justify-center rounded-md border-2 border-white text-white hover:bg-white hover:text-[#0072CE] transition-colors" aria-label="TikTok">
