                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 text-center">
                            ...
                            <a href={`tel:+${config.directorContact.phone}`} className="text-rentia-blue font-bold text-sm hover:underline block">
                                +{config.directorContact.phone.slice(0, 2)} {config.directorContact.phone.slice(2, 5)} {config.directorContact.phone.slice(5, 7)} {config.directorContact.phone.slice(7, 9)} {config.directorContact.phone.slice(9)}
                            </a>
