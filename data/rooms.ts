...
export const properties: Property[] = [
  {
    ...
    rooms: [
      ...
      { id: 'VELAZQ12_H5', name: 'H5', price: 270, status: 'occupied', availableFrom: '07/09/2025', expenses: 'Gastos fijos aparte', targetProfile: 'both', hasAirConditioning: false, hasFan: true, video: 'https://youtube.com/shorts/WUot0rN0fTA', images: ['https://i.ibb.co/gMP6FMMW/1729857047393.jpg'] },
      { id: 'VELAZQ12_H6', name: 'H6', price: 280, status: 'occupied', availableFrom: '15/07/2025', expenses: 'Gastos fijos aparte', targetProfile: 'both', hasAirConditioning: true, video: 'https://youtube.com/shorts/GFWIeP0r8Z8', images: ['https://i.ibb.co/qLQ8Jgvc/1729857047292.jpg'] },
      { id: 'VELAZQ12_H7', name: 'H7', price: 320, status: 'occupied', availableFrom: '01/08/2025', expenses: 'Gastos fijos aparte', targetProfile: 'both', hasAirConditioning: true, video: 'https://youtube.com/shorts/lj-qYj0pY4M', images: ['https://i.ibb.co/3984GxTs/1729857047150.jpg'] },
    ]
  },
  {
    id: 'ROSARIO71',
