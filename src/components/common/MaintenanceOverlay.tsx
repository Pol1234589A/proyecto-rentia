  ...
  return (
    <div className="relative w-full h-full min-h-screen overflow-hidden">
      ...
      <div className="absolute inset-0 z-50 flex flex-col items-center justify-center p-4">
        <div className="bg-white/90 backdrop-blur-xl border border-white/50 p-8 rounded-2xl shadow-2xl text-center max-w-md w-full animate-in zoom-in-95 duration-500">
